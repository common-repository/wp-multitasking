...
class WPMT_BBCode {
    ...
    function shortcode_quote($atts = array(), $content = NULL) {
        ...
        if ("" === $atts) {
            ...
            If ("" !== $subattribs)
                return '<strong>' . $subattribs . ' wrote: </strong><blockquote>' . do_shortcode($content) . '</blockquote>';
        }
    }
    ...
    function shortcode_youtube($atts = array(), $content = NULL) {
        ...
        $id = $text = $content;
        return '<object width="660" height="420"><param name="movie" value="http://www.youtube.com/v/' . $id . '"></param><embed src="http://www.youtube.com/v/' . $id . '" type="application/x-shockwave-flash" width="660" height="420"></embed></object>';
    }
    ...
    function shortcode_gvideo($atts = array(), $content = NULL) {
        ...
        $id = $text = $content;
        return '<embed style="width:660px; height:420px;" id="VideoPlayback" type="application/x-shockwave-flash" src="http://video.google.com/googleplayer.swf?docId=' . $id . '&hl=en"></embed>';
    }
...
add_action( 'plugins_loaded', array( 'WPMT_BBCode', 'init' ) );